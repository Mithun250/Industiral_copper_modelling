...
with tab1:    
    ...
    if submit_button and flag == 0:
        with open("C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)

        with open('C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open("C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open("C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        with open("C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open('C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open("C:\\Users\\91915\\OneDrive\\Desktop\\IC_Factory\\files\\ct.pkl", 'rb') as f:
